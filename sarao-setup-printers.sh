...
lpadmin -p LH?-East  -E -v lpd://katscan1.kat.ac.za/print   -P /usr/local/share/sarao-printers/KOC751iUX.ppd -L "Liesbeek House Ground Floor East" -D "LH?-East"
lpadmin -p LH?-West  -E -v lpd://katscan2.kat.ac.za/print   -P /usr/local/share/sarao-printers/KOC751iUX.ppd -L "Liesbeek House Ground Floor West" -D "LH?-West"
